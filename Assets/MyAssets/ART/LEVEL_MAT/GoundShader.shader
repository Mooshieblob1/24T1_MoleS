	...
	LOD 0
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float grayscale95 = Luminance(staticSwitch123.rgb);
				...
				o.Albedo = ( _TextureColor * appendResult28 ).rgb;
