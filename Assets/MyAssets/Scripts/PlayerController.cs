...
namespace MoleSurvivor
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        [SerializeField] TileDestroyer tDestroyer;
        ...
        KeyCode? key1 = null, key2 = null, key3 = null, key4 = null;
            ...
            if (isAllowedToMove)
            {
                ...
                if (!characterMovement.ReturnCheckIsMoving())
                {
                    if (_inputM != Vector2.zero) // I only put this so it could stop when pause
                    {
                        ...
                        // Move
                        StartCoroutine(characterMovement.Move(CheckBeforeMove, CheckAfterMove, transform, targetPos, new Vector3(0, _inputR, 0), moveSpeed, rotateSpeed));
